---
title: "坎坷的博客装修之路"
description: 站在前人的肩膀上修整博客，重复的部分就不赘述了，主要记录自己个性化和饶了点弯路的地方。
...
参考的博文见[about](https://joyscyberspace.github.io/about/)中的链接
...
stack 主题中文章标题是`<h2>`,markdown 从##开始写也是`<h2>`,有点强迫症，把文章标题改成`<h1>`。还有文章的description用的是`<h3>`，觉得有点莫名其妙，也修改成了`<p>`。然后调整了 `<h1>`~`<h6>` 的字体大小。
